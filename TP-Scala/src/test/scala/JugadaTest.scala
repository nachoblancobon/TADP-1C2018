...
class JugadaTest extends FlatSpec with Matchers {
  ...
  */
  ...
  "Los escenarios posibles de JugarACara " should " son duplicar monto o perder todo" in{
    ...
    jugarACara.escenariosPosibles(10,DistribucionCaraCruz(0.3)) should be(List(EscenarioPosible(20, 0.3), EscenarioPosible(0, 0.7)))
    jugarACara.escenariosPosibles(10,DistribucionCaraCruz(0.0)) should be(List(EscenarioPosible(20, 0.0), EscenarioPosible(0, 1.0)))
  }
  ...
  "Los escenarios posibles de JugarACruz " should " son duplicar monto o perder todo" in{
    ...
    jugarACruz.escenariosPosibles(10,DistribucionCaraCruz(0.3)) should be(List(EscenarioPosible(20, 0.7), EscenarioPosible(0, 0.3)))
    jugarACruz.escenariosPosibles(10,DistribucionCaraCruz(0.0)) should be(List(EscenarioPosible(20, 1.0), EscenarioPosible(0, 0.0)))
  }
  ...
  "Los escenarios posibles de JugarAlRojo " should " son duplicar monto o perder todo" in{
    ...
    jugarAlRojo.escenariosPosibles(10, DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(20, DoubleFormatter.format(18.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(19.0/37.0))))
  }
  ...
  "Los escenarios posibles de JugarAlNegro " should " son duplicar monto o perder todo" in{
    ...
    jugarAlNegro.escenariosPosibles(10, DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(20, DoubleFormatter.format(18.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(19.0/37.0))))
  }

  "Los escenarios posibles de JugarANumero " should " son duplicar monto o perder todo" in{
    (0 to 36).map(JugarNumero).foreach(_.escenariosPosibles(10, DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(360, DoubleFormatter.format(1.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(36.0/37.0)))))

    JugarNumero(1).escenariosPosibles(10, DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(1))) should be(List(EscenarioPosible(360, 1.0), EscenarioPosible(0, 0.0)))
    JugarNumero(2).escenariosPosibles(10, DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(1))) should be(List(EscenarioPosible(360, 0.0), EscenarioPosible(0, 1.0)))
  }
  ...
  "Los escenarios posibles de JugarPar " should " son duplicar monto o perder todo" in{
    ...
    jugarPar.escenariosPosibles(10, DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(20, DoubleFormatter.format(18.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(19.0/37.0))))
  }
  ...
  "Los escenarios posibles de JugarImpar " should " son duplicar monto o perder todo" in{
    ...
    jugarImpar.escenariosPosibles(10, DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(20, DoubleFormatter.format(18.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(19.0/37.0))))
  }
  ...
  "Los escenarios posibles de JugarDecena " should " son duplicar monto o perder todo" in{
    ...
    jugarDecena1.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(1))) should be(List(EscenarioPosible(30, 1.0), EscenarioPosible(0, 0.0)))
    jugarDecena2.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(1))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))
    jugarDecena3.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(1))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))

    jugarDecena1.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(17))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))
    jugarDecena2.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(17))) should be(List(EscenarioPosible(30, 1.0), EscenarioPosible(0, 0.0)))
    jugarDecena3.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(17))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))

    jugarDecena1.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(33))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))
    jugarDecena2.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(33))) should be(List(EscenarioPosible(30, 0.0), EscenarioPosible(0, 1.0)))
    jugarDecena3.escenariosPosibles(10,DistribucionProbabilidadFactory.eventoSeguro(SucesoRuleta(33))) should be(List(EscenarioPosible(30, 1.0), EscenarioPosible(0, 0.0)))

    jugarDecena1.escenariosPosibles(10,DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(30, DoubleFormatter.format(12.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(25.0/37.0))))
    jugarDecena2.escenariosPosibles(10,DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(30, DoubleFormatter.format(12.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(25.0/37.0))))
    jugarDecena3.escenariosPosibles(10,DistribucionProbabilidadFactory.distribucionEquiprobableRuleta) should be(List(EscenarioPosible(30, DoubleFormatter.format(12.0/37.0)), EscenarioPosible(0, DoubleFormatter.format(25.0/37.0))))
  }
}
